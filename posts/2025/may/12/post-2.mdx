---
title: "Example post #2 - Astro blog"
date: '12/05/2025, 13:36'
image: ./Radio._CBC_Offices_BAnQ_P48S1P23108_(cropped).jpeg
tags:
  - wiki
  - example
keywords:
...
First paragraph of test in mdx file will be used as post preview.

![](./Radio._CBC_Offices_BAnQ_P48S1P23108_(cropped).jpeg)

Definition of [Blog](https://en.wikipedia.org/wiki/Blog) according to wiki.
